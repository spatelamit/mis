...
@elseif($data['tab'] == 'health_checker')
    <?php 
        $main=array();
        $time = array();
...
@elseif($data['tab'] == 'kannel')
    <div class="row active">
        <div class="col-md-6 col-sm-6 col-xs-12"> <div class="stats-last-agile"> <div id="upstream"></div> </div> </div>
        <div class="col-md-6 col-sm-6 col-xs-12"><div class="stats-last-agile">  <div id="smppbox"></div> </div> </div>
        <div class="col-md-6 col-sm-6 col-xs-12"><div class="stats-last-agile">  <div id="rabbitmq" ></div> </div> </div>
    </div>
