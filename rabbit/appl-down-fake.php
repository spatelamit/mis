...
require_once __DIR__ . '/function-fake.php';
...
///kannel.down.send IS (Q1)
$channel_consume->basic_qos(null, 5000, null);
$channel_consume->basic_consume(MT1_FAKE, 'APPL', false, false, false, false, 'process_message');
